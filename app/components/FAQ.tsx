...
const faqs = [
  {
    ...
    answer:
      "Most clients receive a shortlist of qualified candidates within 48 hours. The exact timeline depends on the role and your requirements.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes. Our candidates are available to work in your preferred time zone, including UK, US, Australian and South African business hours.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "No. We specialise in recruitment and placing exceptional remote talent. We can, however, recommend trusted payroll partners if required.",
  },
  {
    question: "What happens if the candidate isn't the right fit?",
    answer:
      "Our goal is long-term success. If things don't work out during the agreed replacement period, we'll work with you to find a suitable replacement.",
  },
];
      ...
      <div className="mx-auto max-w-5xl px-6">
        <div className="text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-slate-600">
            Here are the questions we get asked most often by businesses looking
